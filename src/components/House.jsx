...
export default function House(props) {
  ...
  return (
    <RigidBody type="fixed" colliders="trimesh">
      ...
      <group position={[-20.42, 5.95, 5.95]} rotation={[-Math.PI / 2, 0, Math.PI / 2]} scale={0.01}>
      ...
      <group position={[-7.11, 6.451, 6.169]} rotation={[-Math.PI / 2, 0, Math.PI / 2]} scale={0.01}>
      ...
      <group position={[-7.11, 6.451, 3.887]} rotation={[-Math.PI / 2, 0, -Math.PI / 2]} scale={0.01}>
      ...
      <group position={[-2.1, 6.44, 12.62]} rotation={[-Math.PI / 2, 0, Math.PI / 2]} scale={0.01}>
      ...
      <group position={[19.53, 6.44, -2.046]} rotation={[-Math.PI / 2, 0, -Math.PI]} scale={0.01}>
      ...
      <group position={[19.086, 1.3, -6.967]} rotation={[-Math.PI / 2, 0, Math.PI / 2]} scale={0.01}>
      ...
      <group position={[27.166, 14.29, 14.18]} rotation={[-Math.PI / 2, 0, 0]} scale={0.01}>
      ...
      <group position={[29.393, 14.29, 14.18]} rotation={[-Math.PI / 2, 0, -Math.PI]} scale={0.01}>
      ...
      <group position={[25.17, 14.29, 11.73]} rotation={[-Math.PI / 2, 0, Math.PI / 2]} scale={0.01}>
      ...
      <mesh geometry={nodes.door5_SM_door5m_0.geometry} material={materials.door5m} position={[-37.21, 5.96, 5.66]} rotation={[-Math.PI / 2, 0, -Math.PI / 2]} scale={0.01} />
      </group>
    </RigidBody>
  )
}
